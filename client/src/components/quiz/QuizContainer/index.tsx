...
import { LearningBuddy } from '@/components/buddy';
...
export const QuizContainer: React.FC<QuizContainerProps> = ({
  ...
  const stars = answers.filter(answer => answer.isCorrect).length;
      ...
      <AnimatePresence mode="wait">
        ...
        {quizState === 'feedback' && currentQuestion && (
          ...
          >
            <QuizFeedback
              isCorrect={isCorrect}
              correctAnswer={currentQuestion.correctAnswer || currentQuestion.correctOrder?.join(' ') || '再看一次题目提示'}
              streak={streak}
